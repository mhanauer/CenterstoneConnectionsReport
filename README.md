...
GPRAAll.AnyAlcohol.x = data.frame(GPRAAll$AnyAlcohol.x)
GPRAAll.AnyAlcohol.y = data.frame(GPRAAll$AnyAlcohol.y)

Goal3ObjectiveA = data.frame(GPRAAll.AnyAlcohol.x, GPRAAll.AnyAlcohol.y)
summary(Goal3ObjectiveA)
colnames(Goal3ObjectiveA) =c("GPRAAll.AnyAlcohol.x", "GPRAAll.AnyAlcohol.y")
...
Goal3ObjectiveADrugs = data.frame(GPRAAll$IllegalDrugs.x, GPRAAll$Cocaine.x, GPRAAll$Marijuana.x, GPRAAll$Heroin.x,  GPRAAll$Morphine.x,  GPRAAll$Dilaudid.x, GPRAAll$Demerol.x, GPRAAll$Percocet.x, GPRAAll$Darvon.x, GPRAAll$Codeine.x, GPRAAll$OxyContin.x, GPRAAll$Methadone.x, GPRAAll$Hallucinogens.x,  GPRAAll$Meth.x,  GPRAAll$Benzos.x, GPRAAll$Barbiturates.x, GPRAAll$GHB.x, GPRAAll$Ketamine.x, GPRAAll$OtherTranq.x, GPRAAll$Inhalants.x, GPRAAll$OtherDrugs.x, GPRAAll$IllegalDrugs.y, GPRAAll$Cocaine.y, GPRAAll$Marijuana.y, GPRAAll$Heroin.y,  GPRAAll$Morphine.y,  GPRAAll$Dilaudid.y, GPRAAll$Demerol.y, GPRAAll$Percocet.y, GPRAAll$Darvon.y, GPRAAll$Codeine.y, GPRAAll$OxyContin.y, GPRAAll$Methadone.y, GPRAAll$Hallucinogens.y,  GPRAAll$Meth.y,  GPRAAll$Benzos.y, GPRAAll$Barbiturates.y, GPRAAll$GHB.y, + 
                                    GPRAAll$Ketamine.y, GPRAAll$OtherTranq.y, GPRAAll$Inhalants.y, GPRAAll$OtherDrugs.y)
Goal3ObjectiveADrugs = data.frame(apply(Goal3ObjectiveADrugs, 2, function(x){ifelse(x < 0, NA, x)}))
...
Goal3ObjectiveADrugsBase = Goal3ObjectiveADrugs[,1:21]
Goal3ObjectiveADrugsBase = data.frame(apply(Goal3ObjectiveADrugsBase, 1, sum))
colnames(Goal3ObjectiveADrugsBase) = c("Base")
head(Goal3ObjectiveADrugsBase)
...
Goal5ObjectiveBEth = data.frame(GPRAAll$White.x, GPRAAll$HispanicLatino.x, GPRAAll$Black.x, GPRAAll$Asian.x, GPRAAll$AmericanIndian.x)
Goal5ObjectiveBEth = data.frame(apply(Goal5ObjectiveBEth, 2, function(x){ifelse(x == 2, 0, ifelse(x == -99, NA, x))}))
