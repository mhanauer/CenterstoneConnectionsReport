...
modelPHQ9 = lme(PHQ9Base ~ time, random = ~1 | ClientID, data = PHQ9_GAD7AnalysisLong)
summary(modelPHQ9)
modelGAD7 = lme(GAD7Base ~ time, random = ~1 | ClientID, data = PHQ9_GAD7AnalysisLong)
summary(modelGAD7)
...
# Not significant
modelHomeGAD7 = lme(GAD7Base ~ LivingWhere.y*time, random = ~1 | ClientID, data = PHQ9_GAD7AnalysisLong)
summary(modelHomeGAD7)

modelHomePHQ9 = lme(PHQ9Base ~ LivingWhere.y*time, random = ~1 | ClientID, data = PHQ9_GAD7AnalysisLong)
summary(modelHomePHQ9)
...
describe.factor(ConnGPRALongAnalysis$Employment.x)
