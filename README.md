...
## So want to subset for both, because we do not want outside of the data range for either intake and or six-month
GPRAAll = subset(GPRAAll, InterviewDate.y < "2018-05-01")
GPRAAll = subset(GPRAAll, InterviewDate.x < "2018-05-01")
...
#### Centerstone Goal 4 Hopositalzations just looking at the percentage of people who said yes to the follwing variables: InpatientPhysical, InpatientMental, InpatientAlcoholSA, ERPhysical, ERMental, ERAlcoholSA
